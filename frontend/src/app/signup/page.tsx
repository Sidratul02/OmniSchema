...
export default function SignupPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #fdf6ee 0%, #fdeee0 50%, #fde8d8 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Inter, sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: "-80px", left: "-80px", width: "360px", height: "360px", borderRadius: "50%", background: "radial-gradient(circle, #fde8cc, transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: "-80px", right: "-80px", width: "360px", height: "360px", borderRadius: "50%", background: "radial-gradient(circle, #fdd8c0, transparent 70%)", pointerEvents: "none" }} />
      ...
      <div className="animate-scaleIn" style={{ width: "440px", background: "rgba(255,252,248,0.92)", border: "1.5px solid #e8dcc8", borderRadius: "24px", padding: "44px", backdropFilter: "blur(20px)", boxShadow: "0 16px 48px rgba(120,90,50,0.12)", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "32px" }}>
          ...
          <p style={{ color: "#b09070", marginTop: "8px", fontSize: "15px" }}>Create your free account ✨</p>
        </div>

        <div style={{ marginBottom: "14px" }}>
          <label style={{ color: "#7a5c38", fontSize: "13px", fontWeight: "600", display: "block", marginBottom: "7px" }}>Full Name</label>
        ...
        <div style={{ marginBottom: "28px" }}>
          ...
          <p style={{ color: "#d9c9b0", fontSize: "12px", marginTop: "5px" }}>Minimum 6 characters</p>
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: "22px", color: "#b09070", fontSize: "14px" }}>
          ...
          <span onClick={() => router.push("/login")} style={{ color: "#c4782a", cursor: "pointer", fontWeight: "600" }}
