...
export default function LoginPage() {
  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(135deg, #0f1419 0%, #1a1f2e 100%)", display: "flex", alignItems: "center", justifyContent: "center", fontFamily: "Inter, sans-serif", position: "relative", overflow: "hidden" }}>
      ...
      <div style={{ position: "absolute", top: "-100px", right: "-80px", width: "400px", height: "400px", borderRadius: "50%", background: "radial-gradient(circle, rgba(14, 165, 233, 0.08), transparent 70%)", pointerEvents: "none" }} />
      <div style={{ position: "absolute", bottom: "-100px", left: "-80px", width: "400px", height: "400px", borderRadius: "50%", background: "radial-gradient(circle, rgba(167, 139, 250, 0.08), transparent 70%)", pointerEvents: "none" }} />
      ...
      <div className="animate-scaleIn" style={{ width: "440px", background: "rgba(30, 36, 56, 0.5)", border: "1.5px solid rgba(100, 116, 139, 0.2)", borderRadius: "24px", padding: "44px", backdropFilter: "blur(20px)", boxShadow: "0 16px 48px rgba(14, 165, 233, 0.1)", position: "relative", zIndex: 1 }}>
        ...
        <div style={{ textAlign: "center", marginBottom: "36px" }}>
          ...
          <p style={{ color: "#94a3b8", marginTop: "8px", fontSize: "15px" }}>Welcome back</p>
        </div>
        ...
        <p style={{ textAlign: "center", marginTop: "22px", color: "#94a3b8", fontSize: "14px" }}>
          ...
          <span onClick={() => router.push("/signup")} style={{ color: "#0ea5e9", cursor: "pointer", fontWeight: "600" }}
